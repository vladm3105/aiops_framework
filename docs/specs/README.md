...
**Integration**: Links to [`../design.md.template`](../../design.md.template) for overall system architecture  
...
**File**: [specs-020-security-by-design.md.template](specs-020-security-by-design.md.template)
- **Status**: Approved
